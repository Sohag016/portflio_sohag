        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-4">
              <span className="text-[10px] uppercase tracking-widest text-slate-400 font-bold sm:text-xs">
                Connect:
              </span>
              <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-white/5 border border-white/10 text-slate-400 flex items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/30 touch-manipulation"
                >
                ...
                <a
                  ...
                  aria-label="ORCID"
                  title="ORCID"
                  className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-white/5 border border-white/10 text-slate-400 flex items-center justify-center hover:bg-[#a6ce39] hover:text-white hover:border-[#a6ce39] transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-[#a6ce39]/30 touch-manipulation"
                >
                  <svg
                    viewBox="0 0 24 24"
                    width="18"
                ...
                <a
                  ...
                  className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-white/5 border border-white/10 text-slate-400 flex items-center justify-center hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-[#25D366]/30 touch-manipulation"
                >
                  <svg
                    viewBox="0 0 24 24"
                    width="18"
